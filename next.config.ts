    ...
    return [
      ...
      },
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self' 'unsafe-inline' 'unsafe-eval' https: wss: data: blob:; frame-ancestors 'self' https://cooperativesausage.com https://www.cooperativesausage.com;" },
