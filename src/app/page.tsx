...
function ViewSegment({ active, onClick, title, icon: Icon, label, layoutId }: {
  ...
  return (
    <button
      ...
      aria-label={title}
      aria-pressed={active}
      className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[10px] font-mono font-medium tracking-[0.1em] transition-colors duration-200 ${
  ...
  return (
    <main className="fixed inset-0 w-full h-full bg-[var(--bg-void)] overflow-hidden">
        ...
        {showSplash && (
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none z-[1]" style={{
              backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(53,214,181,0.015) 2px, rgba(53,214,181,0.015) 4px)',
            ...
            <motion.div
              ...
              className="absolute top-6 left-6 z-[2] font-mono text-[11px] tracking-[0.1em] text-[var(--gold-primary)]"
            >
              V4.2
            </motion.div>
            ...
            <div className="relative w-40 h-40 mb-8 flex items-center justify-center z-[2]">
              ...
              <motion.div
                ...
                style={{ border: '1px solid rgba(53,214,181,0.2)' }}
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full" style={{ background: 'var(--gold-primary)', boxShadow: '0 0 12px var(--gold-primary), 0 0 24px rgba(53,214,181,0.3)' }} />
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-1 h-1 rounded-full" style={{ background: 'rgba(53,214,181,0.5)', boxShadow: '0 0 6px rgba(53,214,181,0.3)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                style={{ inset: '18px', border: '1px solid rgba(147,180,255,0.15)' }}
              >
                <div className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full" style={{ background: 'var(--cyan-primary)', boxShadow: '0 0 8px rgba(147,180,255,0.35)' }} />
                <div className="absolute bottom-0 left-1/4 translate-y-1/2 w-1 h-1 rounded-full" style={{ background: 'rgba(147,180,255,0.4)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute rounded-full"
                style={{ inset: '40px', border: '1px solid rgba(53,214,181,0.25)' }}
              >
              ...
              <motion.div
                ...
                style={{ border: '2px solid var(--gold-primary)', boxShadow: '0 0 20px rgba(53,214,181,0.15), inset 0 0 20px rgba(53,214,181,0.05)' }}
              >
                <motion.div
                  animate={{ opacity: [0.3, 0.8, 0.3] }}
                  transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
                  className="w-5 h-5 rounded-full"
                  style={{ background: 'radial-gradient(circle, rgba(53,214,181,0.4) 0%, rgba(53,214,181,0.05) 70%)' }}
                />
                {/* Crosshair lines */}
                <div className="absolute w-[1px] h-full" style={{ background: 'linear-gradient(to bottom, transparent, rgba(53,214,181,0.3), transparent)' }} />
                <div className="absolute w-full h-[1px]" style={{ background: 'linear-gradient(to right, transparent, rgba(53,214,181,0.3), transparent)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                style={{ background: 'conic-gradient(from 0deg, transparent 0deg, rgba(53,214,181,0.15) 40deg, transparent 80deg)' }}
              />
            </div>
            ...
            <div className="flex items-center gap-[2px] mb-3 z-[2]">
              {'MERIDIAN'.split('').map((letter, i) => (
                <motion.span
                  ...
                  className="text-4xl md:text-5xl font-bold tracking-[0.1em] font-mono"
                  style={{ color: 'var(--text-heading)', textShadow: '0 0 30px rgba(53,214,181,0.2)' }}
                >
                  {letter}
                </motion.span>
              ))}
            ...
            <div className="overflow-hidden mb-8 z-[2]">
              ...
              >
                <p className="text-[11px] md:text-[10px] font-mono tracking-[0.1em] text-[var(--gold-primary)]" style={{ opacity: 0.8 }}>
            ...
            <div className="w-64 md:w-80 z-[2]">
              {/* Thin progress track */}
              <div className="relative w-full h-[2px] rounded-full overflow-hidden" style={{ background: 'rgba(53,214,181,0.1)' }}>
                <motion.div
                  initial={{ width: '0%' }}
                  animate={{ width: ['0%', '25%', '50%', '78%', '100%'] }}
                  transition={{ duration: 2.2, delay: 0.5, times: [0, 0.25, 0.5, 0.75, 1], ease: 'easeInOut' }}
                  className="absolute inset-y-0 left-0 rounded-full"
                  style={{ background: 'linear-gradient(90deg, var(--gold-primary), var(--cyan-primary), var(--gold-primary))', boxShadow: '0 0 12px rgba(53,214,181,0.4)' }}
                />
              </div>
              ...
              <div className="mt-3 h-4 flex items-center justify-center">
                {[
                  ...
                  <motion.span
                    ...
                    className="absolute text-[10px] font-mono tracking-[0.1em]"
            ...
            <div className="absolute inset-0 pointer-events-none z-[0]" style={{ opacity: 0.03 }}>
              <div className="absolute inset-0" style={{
                backgroundImage: 'linear-gradient(rgba(53,214,181,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(53,214,181,0.5) 1px, transparent 1px)',
      ...
      >
        ...
        <div className="flex items-center gap-[3px] p-[3px] pointer-events-auto rounded-xl border border-[var(--border-primary)] bg-[var(--bg-panel)] shadow-[0_8px_32px_rgba(0,0,0,0.55)]">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 2.5 }} className={`absolute top-4 z-[200] pointer-events-none flex flex-col`} style={{ left: isMobile ? '24px' : '64px', right: '24px' }}>
        <div className="flex items-center gap-3 w-fit">
          <svg viewBox="0 0 650 500" className="w-8 h-8 md:w-10 md:h-10 shrink-0 text-[var(--gold-primary)]" fill="currentColor">
          ...
          <div className="flex flex-col items-start gap-0.5">
            <h1 className="text-lg md:text-xl font-semibold tracking-[-0.01em] text-[var(--text-primary)]">Meridian</h1>
            <span className="text-[11px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)]">Open source intelligence</span>
          </div>
        </div>
        <div className="flex items-center gap-3 mt-1.5 pl-[44px] min-w-0 pr-4">
          <span className="text-[11px] text-[var(--text-muted)] font-mono tracking-[0.1em] uppercase truncate">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 3 }} className="status-bar-desktop absolute top-4 right-6 z-[200] pointer-events-none flex items-center gap-3 text-[10px] font-mono tracking-[0.1em] text-[var(--text-muted)]">
        ...
        <span className="text-[11px] font-bold tracking-[0.1em] text-[var(--text-muted)] opacity-50">V.4.1</span>
      ...
      {!isMobile && <div className="absolute right-2 top-1/2 -translate-y-1/2 flex flex-col gap-2 z-[250] pointer-events-auto bg-black/40 p-1 rounded-full border border-white/5">
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">RECON</span>
          <AnimatePresence>
            {showIntel && (
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">SPACE</span>
          <AnimatePresence>
            {showSpaceCam && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-80">
                <SpaceCam />
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">MARKETS</span>
          <AnimatePresence>
            {showMarkets && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-80">
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">ALERTS</span>
          <AnimatePresence>
            {showAlerts && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-80">
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">DRAW</span>
        </div>
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">ROUTE</span>
        </div>
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">SEARCH</span>
          <AnimatePresence>
            {showDesktopSearch && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-80">
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">ARCGIS</span>
          <AnimatePresence>
            {showArcGIS && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-[340px]">
                <div className="glass-panel p-3 max-h-[70vh] overflow-y-auto styled-scrollbar">
                  <ArcGISPanel
                    onImportLayer={(layer) => setArcgisLayers(prev => [...prev.filter(l => l.id !== layer.id), { ...layer, color: layer.color || '#35D6B5', visible: true, opacity: layer.opacity ?? 0.8 }])}
        ...
        <div className="relative group">
          ...
          <span className="absolute right-11 top-1/2 -translate-y-1/2 px-2 py-1 text-[9px] font-mono tracking-wider text-white/80 bg-black/80 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none">REMOTE</span>
          <AnimatePresence>
            {showRemote && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-80">
              ...
              {liveFeedEmbedAllowed ? (
                ...
                <div className="w-full aspect-video flex items-center justify-center bg-black/95">
                  <div className="text-center px-8">
                    ...
                    <p className="text-[12px] font-mono font-bold text-white tracking-[0.1em] mb-2">EMBED RESTRICTED</p>
                ...
                <div className="px-3 pb-3">
                  <div className="flex items-center justify-between mb-2">
                    <span className="hud-text text-[10px] text-[var(--text-primary)]">
                      {mobilePanel === 'layers' ? 'LAYERS & STATS' : mobilePanel === 'markets' ? 'MARKETS & INTEL' : mobilePanel === 'intel' ? 'INTEL FEED' : mobilePanel === 'recon' ? 'MERIDIAN RECON' : mobilePanel === 'remote' ? 'WORLD REMOTE' : 'SEARCH'}
                    </span>
      ...
      {!isMobile && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 3, duration: 0.8 }} className="desktop-only absolute bottom-8 z-[200] pointer-events-auto" style={{ left: '72px' }}>
          <div className="flex items-center gap-5 text-[9px] font-mono tracking-[0.1em] text-[var(--text-muted)] opacity-60">
          ...
          <div className="glass-panel p-5 osiris-glow">
            ...
            {dossierLoading ? (
              <div className="text-center py-8">
                ...
                <span className="text-[9px] font-mono text-[var(--text-muted)] tracking-[0.1em]">COMPILING INTEL...</span>
              </div>
            ) : regionDossier && (
      ...
      <div className="desktop-only absolute bottom-[26px] right-5 z-[200] pointer-events-none text-[9px] font-mono text-[var(--text-muted)] opacity-50 tracking-[0.1em]" title="Press ? to see all keyboard shortcuts">
