  ...
  return (
    <div className="docs-root min-h-screen bg-[var(--bg-void)] text-[var(--text-primary)] antialiased">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(900px 480px at 12% -8%, rgba(53,214,181,0.07), transparent 65%), radial-gradient(760px 420px at 92% 4%, rgba(147,180,255,0.05), transparent 62%)',
        }}
      />
      ...
      {/* ── Header ── */}
      <header className="sticky top-0 z-[300] border-b border-white/[0.06] bg-[var(--bg-void)]/85">
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 h-14 flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
            <svg
              viewBox="0 0 650 500"
              className="w-6 h-6 text-[var(--gold-primary)] transition-all group-hover:drop-shadow-[0_0_10px_rgba(53,214,181,0.6)]"
              fill="currentColor"
              aria-hidden="true"
            >
            ...
            <span className="flex flex-col leading-none">
              <span className="text-[12px] font-bold tracking-[0.1em] text-[var(--gold-primary)] font-mono">
                OSIRIS
              </span>
              <span className="text-[9px] font-mono tracking-[0.1em] text-[var(--text-muted)] uppercase mt-[3px]">
                Docs
              </span>
            </span>
          </Link>
          ...
          <Link
            href="/"
            className="hidden md:inline-flex items-center gap-1.5 text-[11px] font-mono tracking-[0.1em] uppercase px-3 h-8 rounded-lg border border-[var(--gold-primary)]/30 bg-[var(--gold-primary)]/[0.08] text-[var(--gold-primary)] hover:bg-[var(--gold-primary)]/[0.18] transition-colors"
          >
            Launch Map
      ...
      {/* Mobile drawer scrim */}
      {navOpen && (
        <div className="lg:hidden fixed inset-0 top-14 z-[250] bg-black/60" onClick={closeNav} />
      )}
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 md:px-8 flex gap-8 xl:gap-12">
        ...
        >
          <div className="text-[10px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)]/70 pl-4 mb-2">
            Guide
          </div>
          {GUIDE_SECTIONS.map(navLink)}

          <div className="text-[10px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)]/70 pl-4 mb-2 mt-7">
            API Reference
          </div>
        ...
        <main ref={mainRef} className="flex-1 min-w-0 py-12 lg:py-16 max-w-3xl">
          ...
          <div className="mb-20">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full border border-[var(--cyan-primary)]/20 bg-[var(--cyan-primary)]/[0.05] mb-6">
              ...
              <span className="text-[10px] font-mono tracking-[0.1em] uppercase text-[var(--text-secondary)]">
                Open Source · MIT
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-10">
              {[
                ...
                <div key={s.l} className="rounded-xl border border-white/[0.07] bg-white/[0.015] px-4 py-3">
                  ...
                  <div className="text-[11px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)] mt-1.5">
                    {s.l}
                  </div>
                </div>
              ))}
...
docker compose up -d`}</Pre>
          ...
          <Section id="configuration" eyebrow="Guide" title="Configuration">
            ...
            <h3 className="text-[12px] font-mono tracking-[0.1em] uppercase text-[var(--text-primary)] pt-2">
            ...
            <h3 className="text-[12px] font-mono tracking-[0.1em] uppercase text-[var(--text-primary)] pt-4">
        ...
        <aside className="hidden xl:block w-52 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto styled-scrollbar py-16">
          <div className="text-[10px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)]/70 mb-3">
            On this page
          </div>
          ...
          <button
            ...
            className="mt-6 flex items-center gap-1.5 text-[11px] font-mono tracking-[0.1em] uppercase text-[var(--text-muted)] hover:text-[var(--gold-primary)] transition-colors"
          >
            <svg viewBox="0 0 24 24" className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
